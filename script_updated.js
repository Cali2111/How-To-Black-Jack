...
function updateDisplay() {
    document.getElementById('player-hand').innerHTML = playerHand.map(displayCard).join('');
    document.getElementById('dealer-hand').innerHTML = dealerHand.map(displayCard).join('');
